    ...
    <div class="game_topbox">
      <div id="game_box">
        <div 
          ...
          />
          <div :class="{'hover':itemNo==index&&isActive}">
          </div>
        </div>
      </div>
    </div>
...
.hovers{
  ...
  .Game_small{
    width: 275px;
    height: 98px;
    background: url(../../static/images/category/1726.png) no-repeat 100% 100%;
    float: left;
    margin-right: 18px;
    font-size: 20px;
    text-align: center;
...
.hover{
    width: 275px;
    height: 98px;
    background: url(../../static/images/category/1892.png) no-repeat;
