...
playerCore = (function () {
  ...
  function createNewMediaPlayer () {
    ...
    mediaObj.setAttribute('hidden', 'no');
 ...
 */
  playerCore.ready = function () {
    ...
    if (navigator.platform == 'Win32' || navigator.platform == 'Windows') { // window 模拟视频播放
...
*/
  ...
  playerCore.removePlay = function (){
    removeAllMediaPlayer();
  };
